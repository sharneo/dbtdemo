...
2026-01-01      0.5                             SCD Type II view over ccx_nonpecuniarybenefit_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_nonpecuniarybenefit_icare')) }}
    FROM {{ ref('ccx_nonpecuniarybenefit_icare') }}
