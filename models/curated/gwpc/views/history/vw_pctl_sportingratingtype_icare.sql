...
2026.01.11      0.0                             This Creates a Current View for the Curated Layer for the Table  
                                                pctl_sportingratingtype_icare . This view contains only the Latest Record Data in the Table
...
SELECT
    {{ dbt_utils.star(from=ref('pctl_sportingratingtype_icare')  ) }}
FROM {{ ref('pctl_sportingratingtype_icare') }}
