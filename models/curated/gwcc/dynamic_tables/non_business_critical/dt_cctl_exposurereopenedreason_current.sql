...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_exposurereopenedreason.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_exposurereopenedreason')) }}
FROM {{ ref('v_cctl_exposurereopenedreason') }}
