...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_retpremexcesstreatment.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_retpremexcesstreatment')) }}
FROM {{ ref('v_bctl_retpremexcesstreatment') }}
