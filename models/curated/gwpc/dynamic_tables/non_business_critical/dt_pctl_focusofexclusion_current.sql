...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_focusofexclusion.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_focusofexclusion')) }}
FROM {{ ref('v_pctl_focusofexclusion') }}
