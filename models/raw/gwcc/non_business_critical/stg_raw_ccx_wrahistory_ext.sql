...
2026-01-01      0.0                             Incremental staging model for ccx_wrahistory_ext.
                                                wrahistory_ext_sk: Entity identity surrogate key on PK ('id')
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "non_business_critical", "ccx_wrahistory_ext"]
) }}
...
(
            ...
            SELECT
                ...
                data_payload:WRADetailsID::NUMBER AS wradetailsid,
                ...
                'AVRO' file_type
            FROM {{ source('gwcc', 'ccx_wrahistory_ext') }}
            ...
            SELECT
                ...
                $1:wradetailsid::NUMBER AS wradetailsid,
                $1:id::NUMBER AS id,
    ...
    SELECT
        *,
        CAST({{ dbt_utils.generate_surrogate_key([
            'id'
        ]) }} AS VARCHAR(150)) AS wrahistory_ext_sk,
        CAST({{ dbt_utils.generate_surrogate_key([
                        'loadcommandid',
                        'createuserid',
                        'publicid',
