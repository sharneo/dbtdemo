...
2026.01.11      0.0                             This Creates a Current View for the Curated Layer for the Table  
                                                cctl_tmptrecipienttype_icare . This view contains only the Latest Record Data in the Table
...
SELECT
    {{ dbt_utils.star(from=ref('cctl_tmptrecipienttype_icare')  ) }}
FROM {{ ref('cctl_tmptrecipienttype_icare') }}
