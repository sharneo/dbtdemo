...
2026-01-01      0.0                             Incremental staging model for ccx_inboundrecord_psc.
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "non_business_critical", "ccx_inboundrecord_psc"]
) }}
