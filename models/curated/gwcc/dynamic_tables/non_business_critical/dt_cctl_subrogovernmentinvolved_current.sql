...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_subrogovernmentinvolved.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_subrogovernmentinvolved')) }}
FROM {{ ref('v_cctl_subrogovernmentinvolved') }}
