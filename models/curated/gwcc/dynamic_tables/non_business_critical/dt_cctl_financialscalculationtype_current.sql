...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_financialscalculationtype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_financialscalculationtype')) }}
FROM {{ ref('v_cctl_financialscalculationtype') }}
