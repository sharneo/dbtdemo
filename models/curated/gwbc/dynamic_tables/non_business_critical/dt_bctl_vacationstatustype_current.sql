...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_vacationstatustype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_vacationstatustype')) }}
FROM {{ ref('v_bctl_vacationstatustype') }}
