...
2026-01-01      0.5                             Curated current-state view for bcx_claimrecoverydetails.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bcx_claimrecoverydetails_current')) }}
    FROM {{ ref('dt_bcx_claimrecoverydetails_current') }}
