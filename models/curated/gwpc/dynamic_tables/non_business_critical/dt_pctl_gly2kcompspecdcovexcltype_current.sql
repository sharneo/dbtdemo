...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_gly2kcompspecdcovexcltype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_gly2kcompspecdcovexcltype')) }}
FROM {{ ref('v_pctl_gly2kcompspecdcovexcltype') }}
