...
2026-01-01      0.5                             Curated current-state view for ccx_piawecheckindexation_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_ccx_piawecheckindexation_ext_current')) }}
    FROM {{ ref('dt_ccx_piawecheckindexation_ext_current') }}
