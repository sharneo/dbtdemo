{% snapshot pcx_crcost_icare_snapshot %}
...
2026-01-01      0.0                             SCD Type 2 snapshot for pcx_crcost_icare.
                                                Source: ref('stg_raw_pcx_crcost_icare')
...
{{ config(
    ...
    strategy='check',
    alias='pcx_crcost_icare',
    check_cols=['hash_key'],
    hard_deletes='new_record',
    tags=['snapshot', 'policy_centre', 'non_business_critical', 'pcx_crcost_icare']
) }}
...
FROM {{ ref('stg_raw_pcx_crcost_icare') }}
