...
2026-01-01      0.5                             Dynamic Table for current-state of pcx_polpmtinstrument_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pcx_polpmtinstrument_icare')) }}
FROM {{ ref('v_pcx_polpmtinstrument_icare') }}
