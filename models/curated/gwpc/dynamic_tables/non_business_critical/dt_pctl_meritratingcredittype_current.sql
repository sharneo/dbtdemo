...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_meritratingcredittype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_meritratingcredittype')) }}
FROM {{ ref('v_pctl_meritratingcredittype') }}
