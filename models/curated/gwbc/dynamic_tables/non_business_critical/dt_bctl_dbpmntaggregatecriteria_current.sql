...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_dbpmntaggregatecriteria.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_dbpmntaggregatecriteria')) }}
FROM {{ ref('v_bctl_dbpmntaggregatecriteria') }}
