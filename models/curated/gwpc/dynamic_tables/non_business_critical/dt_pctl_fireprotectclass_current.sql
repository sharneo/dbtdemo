...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_fireprotectclass.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_fireprotectclass')) }}
FROM {{ ref('v_pctl_fireprotectclass') }}
