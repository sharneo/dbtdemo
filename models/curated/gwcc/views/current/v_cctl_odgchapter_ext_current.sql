...
2026-01-01      0.5                             Curated current-state view for cctl_odgchapter_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cctl_odgchapter_ext_current')) }}
    FROM {{ ref('dt_cctl_odgchapter_ext_current') }}
