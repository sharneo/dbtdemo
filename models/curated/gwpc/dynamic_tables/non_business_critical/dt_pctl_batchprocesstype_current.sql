...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_batchprocesstype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_batchprocesstype')) }}
FROM {{ ref('v_pctl_batchprocesstype') }}
