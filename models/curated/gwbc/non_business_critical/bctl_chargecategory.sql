...
2026.01.11      0.0                             This Creates a DBT Incremental Model for the Curated Layer
                                                This Model is for the Curated table bctl_chargecategory in Schema gwbc in the Curated Layer 
-#}
...
SELECT
    {{ dbt_utils.star(from=ref('vw_raw_bctl_chargecategory')) }}
FROM {{ ref('vw_raw_bctl_chargecategory') }} AS src
