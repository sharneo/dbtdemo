...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_clearinglogictarget.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_clearinglogictarget')) }}
FROM {{ ref('v_bctl_clearinglogictarget') }}
