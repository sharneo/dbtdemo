...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_transferstatus_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_transferstatus_ext')) }}
FROM {{ ref('v_pctl_transferstatus_ext') }}
