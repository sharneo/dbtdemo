...
2026-01-01      0.5                             SCD Type II view over cctl_wpidocassmtoutcome_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('cctl_wpidocassmtoutcome_ext')) }}
    FROM {{ ref('cctl_wpidocassmtoutcome_ext') }}
