...
2026-01-01      0.0                             Incremental staging model for cc_medicalcontactstatus.
                                                medicalcontactstatus_sk: Entity identity surrogate key on PK ('id')
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "non_business_critical", "cc_medicalcontactstatus"]
) }}
