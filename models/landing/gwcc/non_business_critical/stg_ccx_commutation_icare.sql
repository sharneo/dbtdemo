...
(
            ...
            SELECT
                ...
                CAST(data_payload:SettlementAmount AS NUMBER(18,2)) AS settlementamount,
                TO_TIMESTAMP_TZ(data_payload:PICApplicationDate::NUMBER/1000) AS picapplicationdate,
            ...
            SELECT
                ...
                CAST($1:settlementamount AS NUMBER(18,2)) AS settlementamount,
                $1:picapplicationdate::TIMESTAMP_TZ AS picapplicationdate,
