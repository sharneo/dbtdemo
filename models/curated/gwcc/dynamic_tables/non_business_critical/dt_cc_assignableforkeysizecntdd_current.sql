...
2026-01-01      0.5                             Dynamic Table for current-state of cc_assignableforkeysizecntdd.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cc_assignableforkeysizecntdd')) }}
FROM {{ ref('v_cc_assignableforkeysizecntdd') }}
