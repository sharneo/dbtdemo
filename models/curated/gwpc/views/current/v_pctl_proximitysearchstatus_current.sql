...
2026-01-01      0.5                             Curated current-state view for pctl_proximitysearchstatus.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_proximitysearchstatus_current')) }}
    FROM {{ ref('dt_pctl_proximitysearchstatus_current') }}
