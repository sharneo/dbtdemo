...
2026.01.11      0.0                             This Creates a DBT Incremental Model for the Curated Layer
                                                This Model is for the Curated table bc_account in Schema gwbc in the Curated Layer 
-#}
...
SELECT
    {{ dbt_utils.star(from=ref('vw_raw_bc_account')) }}
FROM {{ ref('vw_raw_bc_account') }} AS src
