...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_accountorgtype_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_accountorgtype_icare')) }}
FROM {{ ref('v_cctl_accountorgtype_icare') }}
