...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_guardianshiptype_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_guardianshiptype_icare')) }}
FROM {{ ref('v_cctl_guardianshiptype_icare') }}
