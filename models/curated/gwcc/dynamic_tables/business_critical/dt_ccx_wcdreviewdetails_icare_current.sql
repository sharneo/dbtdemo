...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_wcdreviewdetails_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_wcdreviewdetails_icare')) }}
FROM {{ ref('v_ccx_wcdreviewdetails_icare') }}
