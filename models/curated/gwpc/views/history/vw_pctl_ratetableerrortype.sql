...
2026.01.11      0.0                             This Creates a Current View for the Curated Layer for the Table  
                                                pctl_ratetableerrortype . This view contains only the Latest Record Data in the Table
...
SELECT
    {{ dbt_utils.star(from=ref('pctl_ratetableerrortype')  ) }}
FROM {{ ref('pctl_ratetableerrortype') }}
