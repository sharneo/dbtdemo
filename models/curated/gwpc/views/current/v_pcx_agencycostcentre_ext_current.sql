...
2026-01-01      0.5                             Curated current-state view for pcx_agencycostcentre_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pcx_agencycostcentre_ext_current')) }}
    FROM {{ ref('dt_pcx_agencycostcentre_ext_current') }}
