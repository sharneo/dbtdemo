...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_groupdetailsupdate_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_groupdetailsupdate_ext')) }}
FROM {{ ref('v_bctl_groupdetailsupdate_ext') }}
