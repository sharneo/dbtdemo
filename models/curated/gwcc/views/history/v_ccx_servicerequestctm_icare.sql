...
2026-01-01      0.5                             SCD Type II view over ccx_servicerequestctm_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_servicerequestctm_icare')) }}
    FROM {{ ref('ccx_servicerequestctm_icare') }}
