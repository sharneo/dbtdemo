...
2026-01-01      0.5                             Curated current-state view for pc_effectivedatedfields.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pc_effectivedatedfields_current')) }}
    FROM {{ ref('dt_pc_effectivedatedfields_current') }}
