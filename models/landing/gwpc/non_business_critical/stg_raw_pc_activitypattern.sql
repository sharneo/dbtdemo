...
2026-01-01      0.0                             Incremental staging model for pc_activitypattern.
...
{{ config(
    ...
    tags=["raw_layer", "raw_policy_centre", "policy_centre", "non_business_critical", "pc_activitypattern"]
) }}
...
(
            ...
            SELECT
                ...
                data_payload:PatternLevel::NUMBER AS patternlevel,
                ...
                data_payload:DefaultAssignmentType::NUMBER AS defaultassignmenttype,
                data_payload:DefaultAssignedGroup::NUMBER AS defaultassignedgroup,
                data_payload:DefaultAssignedQueue::NUMBER AS defaultassignedqueue,
                ...
                'AVRO' file_type
            FROM {{ source('gwpc', 'pc_activitypattern') }}
            ...
            SELECT
                ...
                $1:patternlevel::NUMBER AS patternlevel,
                ...
                $1:defaultassignmenttype::NUMBER AS defaultassignmenttype,
                $1:defaultassignedgroup::NUMBER AS defaultassignedgroup,
                $1:defaultassignedqueue::NUMBER AS defaultassignedqueue,
