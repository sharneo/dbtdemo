...
2026-01-01      0.5                             Dynamic Table for current-state of pcx_lpradjustment_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pcx_lpradjustment_icare')) }}
FROM {{ ref('v_pcx_lpradjustment_icare') }}
