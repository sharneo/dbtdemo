...
2026-01-01      0.5                             Dynamic Table for current-state of abtl_primaryphonetype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_abtl_primaryphonetype')) }}
FROM {{ ref('v_abtl_primaryphonetype') }}
