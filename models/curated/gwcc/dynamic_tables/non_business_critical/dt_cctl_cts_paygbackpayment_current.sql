...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_cts_paygbackpayment.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_cts_paygbackpayment')) }}
FROM {{ ref('v_cctl_cts_paygbackpayment') }}
