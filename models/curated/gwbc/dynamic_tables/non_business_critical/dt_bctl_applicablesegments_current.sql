...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_applicablesegments.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_applicablesegments')) }}
FROM {{ ref('v_bctl_applicablesegments') }}
