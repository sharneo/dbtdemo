...
2026-01-01      0.0                             Incremental staging model for ccx_reimbtotranslineitems.
                                                reimbtotranslineitems_sk: Entity identity surrogate key on PK ('id')
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "business_critical", "ccx_reimbtotranslineitems"]
) }}
