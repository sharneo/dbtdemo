...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_bopconstructiontype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_bopconstructiontype')) }}
FROM {{ ref('v_pctl_bopconstructiontype') }}
