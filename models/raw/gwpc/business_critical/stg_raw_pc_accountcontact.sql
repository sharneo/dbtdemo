...
2026-01-01      0.0                             Incremental staging model for pc_accountcontact.
...
{{ config(
    ...
    tags=["raw_layer", "raw_policy_centre", "policy_centre", "business_critical", "pc_accountcontact"]
) }}
...
(
            ...
            SELECT
                ...
                'AVRO' file_type
            FROM {{ source('gwpc', 'pc_accountcontact') }}
