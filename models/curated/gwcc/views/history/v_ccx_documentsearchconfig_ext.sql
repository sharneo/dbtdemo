...
2026-01-01      0.5                             SCD Type II view over ccx_documentsearchconfig_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_documentsearchconfig_ext')) }}
    FROM {{ ref('ccx_documentsearchconfig_ext') }}
