...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_claimscreenaction_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_claimscreenaction_icare')) }}
FROM {{ ref('v_cctl_claimscreenaction_icare') }}
