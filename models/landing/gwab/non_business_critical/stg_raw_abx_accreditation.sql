...
2026-01-01      0.0                             Incremental staging model for abx_accreditation.
...
{{ config(
    ...
    tags=["raw_layer", "raw_contact_manager", "contact_manager", "non_business_critical", "abx_accreditation"]
) }}
