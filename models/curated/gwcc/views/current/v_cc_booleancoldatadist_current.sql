...
2026-01-01      0.5                             Curated current-state view for cc_booleancoldatadist.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cc_booleancoldatadist_current')) }}
    FROM {{ ref('dt_cc_booleancoldatadist_current') }}
