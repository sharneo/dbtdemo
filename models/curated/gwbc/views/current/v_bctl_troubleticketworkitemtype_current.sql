...
2026-01-01      0.5                             Curated current-state view for bctl_troubleticketworkitemtype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bctl_troubleticketworkitemtype_current')) }}
    FROM {{ ref('dt_bctl_troubleticketworkitemtype_current') }}
