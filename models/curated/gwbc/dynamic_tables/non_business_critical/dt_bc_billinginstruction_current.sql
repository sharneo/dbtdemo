...
2026-01-01      0.5                             Dynamic Table for current-state of bc_billinginstruction.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bc_billinginstruction')) }}
FROM {{ ref('v_bc_billinginstruction') }}
