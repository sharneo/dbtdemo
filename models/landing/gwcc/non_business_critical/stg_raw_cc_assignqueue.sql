...
2026-01-01      0.0                             Incremental staging model for cc_assignqueue.
                                                assignqueue_sk: Entity identity surrogate key on PK ('id')
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "non_business_critical", "cc_assignqueue"]
) }}
...
(
            ...
            SELECT
                ...
                data_payload:QueueType_icare::NUMBER AS queuetype_icare,
                ...
                'AVRO' file_type
            FROM {{ source('gwcc', 'cc_assignqueue') }}
            ...
            SELECT
                ...
                $1:queuetype_icare::NUMBER AS queuetype_icare,
