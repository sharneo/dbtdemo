...
2026-01-01      0.0                             Incremental staging model for abtl_abcontact.
                                                abcontact_sk: Entity identity surrogate key on PK ('id')
...
{{ config(
    ...
    tags=["layer:stg", "platform:guidewire","module:gwab","domain:contact_manager", "criticality:non_business_critical", "entity:abtl_abcontact"]
) }}
...
(
            ...
            FROM {{ source('gwab', 'abtl_abcontact') }}
