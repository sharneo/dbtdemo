...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_approvalclassif_psc.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_approvalclassif_psc')) }}
FROM {{ ref('v_cctl_approvalclassif_psc') }}
