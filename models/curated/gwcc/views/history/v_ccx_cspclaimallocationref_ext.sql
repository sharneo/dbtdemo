...
2026-01-01      0.5                             SCD Type II view over ccx_cspclaimallocationref_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_cspclaimallocationref_ext')) }}
    FROM {{ ref('ccx_cspclaimallocationref_ext') }}
