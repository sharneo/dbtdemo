...
2026-01-01      0.5                             Curated current-state view for pctl_ruleimportstatus.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_ruleimportstatus_current')) }}
    FROM {{ ref('dt_pctl_ruleimportstatus_current') }}
