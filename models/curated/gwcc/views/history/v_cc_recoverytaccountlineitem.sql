...
2026-01-01      0.5                             SCD Type II view over cc_recoverytaccountlineitem.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('cc_recoverytaccountlineitem')) }}
    FROM {{ ref('cc_recoverytaccountlineitem') }}
