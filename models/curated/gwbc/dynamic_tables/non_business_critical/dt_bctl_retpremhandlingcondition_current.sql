...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_retpremhandlingcondition.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_retpremhandlingcondition')) }}
FROM {{ ref('v_bctl_retpremhandlingcondition') }}
