...
2026-01-01      0.5                             SCD Type II view over cctl_excesslegislationtype_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('cctl_excesslegislationtype_ext')) }}
    FROM {{ ref('cctl_excesslegislationtype_ext') }}
