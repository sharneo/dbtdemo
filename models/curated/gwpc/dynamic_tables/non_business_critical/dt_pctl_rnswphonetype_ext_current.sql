...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_rnswphonetype_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_rnswphonetype_ext')) }}
FROM {{ ref('v_pctl_rnswphonetype_ext') }}
