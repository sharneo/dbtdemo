...
2026.01.11      0.0                             This Creates a DBT Incremental Model for the Curated Layer
                                                This Model is for the Curated table ccx_documentrecipient_psc in Schema gwcc in the Curated Layer 
-#}
...
SELECT
    {{ dbt_utils.star(from=ref('vw_raw_ccx_documentrecipient_psc')) }}
FROM {{ ref('vw_raw_ccx_documentrecipient_psc') }} AS src
