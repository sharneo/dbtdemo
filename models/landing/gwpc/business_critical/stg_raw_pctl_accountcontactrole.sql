...
2026-01-01      0.0                             Incremental staging model for pctl_accountcontactrole.
...
{{ config(
    ...
    tags=["raw_layer", "raw_policy_centre", "policy_centre", "business_critical", "pctl_accountcontactrole"]
) }}
...
(
            ...
            SELECT
                ...
                'AVRO' file_type
            FROM {{ source('gwpc', 'pctl_accountcontactrole') }}
