...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_systempermissiontype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_systempermissiontype')) }}
FROM {{ ref('v_cctl_systempermissiontype') }}
