...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_modifierdatatype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_modifierdatatype')) }}
FROM {{ ref('v_pctl_modifierdatatype') }}
