...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_troubletkthold_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_troubletkthold_ext')) }}
FROM {{ ref('v_bctl_troubletkthold_ext') }}
