...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_workflowlogentry.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_workflowlogentry')) }}
FROM {{ ref('v_bctl_workflowlogentry') }}
