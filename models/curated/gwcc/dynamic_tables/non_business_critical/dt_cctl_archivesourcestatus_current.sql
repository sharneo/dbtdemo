...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_archivesourcestatus.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_archivesourcestatus')) }}
FROM {{ ref('v_cctl_archivesourcestatus') }}
