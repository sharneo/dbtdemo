...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_ratesubtotaltype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_ratesubtotaltype')) }}
FROM {{ ref('v_pctl_ratesubtotaltype') }}
