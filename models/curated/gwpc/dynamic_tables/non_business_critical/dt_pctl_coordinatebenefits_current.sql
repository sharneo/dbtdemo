...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_coordinatebenefits.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_coordinatebenefits')) }}
FROM {{ ref('v_pctl_coordinatebenefits') }}
