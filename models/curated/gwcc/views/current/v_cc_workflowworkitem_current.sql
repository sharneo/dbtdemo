...
2026-01-01      0.5                             Curated current-state view for cc_workflowworkitem.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cc_workflowworkitem_current')) }}
    FROM {{ ref('dt_cc_workflowworkitem_current') }}
