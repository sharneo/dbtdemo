...
2026-01-01      0.5                             SCD Type II view over ccx_subadvpartyrecovery_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_subadvpartyrecovery_icare')) }}
    FROM {{ ref('ccx_subadvpartyrecovery_icare') }}
