...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_roundingmodetype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_roundingmodetype')) }}
FROM {{ ref('v_pctl_roundingmodetype') }}
