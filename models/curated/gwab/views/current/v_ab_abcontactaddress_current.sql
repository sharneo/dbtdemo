...
2026-01-01      0.5                             Curated current-state view for ab_abcontactaddress.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_ab_abcontactaddress_current')) }}
    FROM {{ ref('dt_ab_abcontactaddress_current') }}
