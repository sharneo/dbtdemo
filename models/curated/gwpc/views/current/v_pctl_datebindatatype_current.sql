...
2026-01-01      0.5                             Curated current-state view for pctl_datebindatatype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_datebindatatype_current')) }}
    FROM {{ ref('dt_pctl_datebindatatype_current') }}
