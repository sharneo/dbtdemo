...
2026-01-01      0.5                             Curated current-state view for cctl_roofmaterial.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cctl_roofmaterial_current')) }}
    FROM {{ ref('dt_cctl_roofmaterial_current') }}
