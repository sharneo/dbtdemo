...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_contactsearchresulttype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_contactsearchresulttype')) }}
FROM {{ ref('v_bctl_contactsearchresulttype') }}
