...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_vehicleindustryuse.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_vehicleindustryuse')) }}
FROM {{ ref('v_pctl_vehicleindustryuse') }}
