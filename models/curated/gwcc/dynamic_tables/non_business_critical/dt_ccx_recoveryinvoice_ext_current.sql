...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_recoveryinvoice_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_recoveryinvoice_ext')) }}
FROM {{ ref('v_ccx_recoveryinvoice_ext') }}
