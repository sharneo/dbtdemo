...
2026-01-01      0.5                             SCD Type II view over ccx_camt053mispresentchk_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_camt053mispresentchk_ext')) }}
    FROM {{ ref('ccx_camt053mispresentchk_ext') }}
