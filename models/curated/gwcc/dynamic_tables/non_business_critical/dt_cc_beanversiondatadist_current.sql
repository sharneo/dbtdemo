...
2026-01-01      0.5                             Dynamic Table for current-state of cc_beanversiondatadist.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cc_beanversiondatadist')) }}
FROM {{ ref('v_cc_beanversiondatadist') }}
