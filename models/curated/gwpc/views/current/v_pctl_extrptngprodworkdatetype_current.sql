...
2026-01-01      0.5                             Curated current-state view for pctl_extrptngprodworkdatetype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_extrptngprodworkdatetype_current')) }}
    FROM {{ ref('dt_pctl_extrptngprodworkdatetype_current') }}
