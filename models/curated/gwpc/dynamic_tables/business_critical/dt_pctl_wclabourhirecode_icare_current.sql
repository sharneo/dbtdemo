...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_wclabourhirecode_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_wclabourhirecode_icare')) }}
FROM {{ ref('v_pctl_wclabourhirecode_icare') }}
