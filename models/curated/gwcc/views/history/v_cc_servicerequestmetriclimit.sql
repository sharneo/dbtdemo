...
2026-01-01      0.5                             SCD Type II view over cc_servicerequestmetriclimit.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('cc_servicerequestmetriclimit')) }}
    FROM {{ ref('cc_servicerequestmetriclimit') }}
