...
2026-01-01      0.5                             Dynamic Table for current-state of abtl_stateabbreviation.
...
SELECT
    {{ dbt_utils.star(from=ref('v_abtl_stateabbreviation')) }}
FROM {{ ref('v_abtl_stateabbreviation') }}
