...
2026-01-01      0.5                             Curated current-state view for pctl_accountstatus.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_accountstatus_current')) }}
    FROM {{ ref('dt_pctl_accountstatus_current') }}
