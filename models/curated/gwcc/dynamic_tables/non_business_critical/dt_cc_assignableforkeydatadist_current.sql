...
2026-01-01      0.5                             Dynamic Table for current-state of cc_assignableforkeydatadist.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cc_assignableforkeydatadist')) }}
FROM {{ ref('v_cc_assignableforkeydatadist') }}
