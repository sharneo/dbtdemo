...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_paymentmoveoption.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_paymentmoveoption')) }}
FROM {{ ref('v_bctl_paymentmoveoption') }}
