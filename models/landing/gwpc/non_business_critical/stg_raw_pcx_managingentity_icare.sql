...
2026-01-01      0.0                             Incremental staging model for pcx_managingentity_icare.
...
{{ config(
    ...
    tags=["raw_layer", "raw_policy_centre", "policy_centre", "non_business_critical", "pcx_managingentity_icare"]
) }}
