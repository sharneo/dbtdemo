...
2026-01-01      0.5                             SCD Type II view over ccx_toocsdutynatureval_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_toocsdutynatureval_icare')) }}
    FROM {{ ref('ccx_toocsdutynatureval_icare') }}
