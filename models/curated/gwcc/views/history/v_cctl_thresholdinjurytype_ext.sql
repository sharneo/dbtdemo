...
2026-01-01      0.5                             SCD Type II view over cctl_thresholdinjurytype_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('cctl_thresholdinjurytype_ext')) }}
    FROM {{ ref('cctl_thresholdinjurytype_ext') }}
