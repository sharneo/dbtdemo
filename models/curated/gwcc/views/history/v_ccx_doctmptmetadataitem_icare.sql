...
2026-01-01      0.5                             SCD Type II view over ccx_doctmptmetadataitem_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_doctmptmetadataitem_icare')) }}
    FROM {{ ref('ccx_doctmptmetadataitem_icare') }}
