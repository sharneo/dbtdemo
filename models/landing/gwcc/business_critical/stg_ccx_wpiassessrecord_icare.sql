...
(
            ...
            SELECT
                ...
                data_payload:WPISubtype::NUMBER AS wpisubtype,
                CAST(data_payload:SALegTypeOverrideReason::TEXT AS VARCHAR(255)) AS salegtypeoverridereason,
                TO_TIMESTAMP_TZ(data_payload:RlvntParticularsDateRqstd::NUMBER/1000) AS rlvntparticularsdaterqstd,
                data_payload:SALegislationType::NUMBER AS salegislationtype,
            ...
            SELECT
                ...
                $1:wpisubtype::NUMBER AS wpisubtype,
                CAST($1:salegtypeoverridereason::TEXT AS VARCHAR(255)) AS salegtypeoverridereason,
                $1:rlvntparticularsdaterqstd::TIMESTAMP_TZ AS rlvntparticularsdaterqstd,
                $1:salegislationtype::NUMBER AS salegislationtype,
    ...
    SELECT
        *,
        ...
        CAST({{ dbt_utils.generate_surrogate_key([
                        ...
                        'legacyupdatetime',
                        'wpisubtype',
                        'salegtypeoverridereason',
                        'rlvntparticularsdaterqstd',
                        'salegislationtype'
