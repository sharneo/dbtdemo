...
2026-01-01      0.0                             Curated current-state view for ccx_managingentity_icare.
...
{{ config(
    materialized='view',
    tags=["curated", "curated_view", "curated_current", "claim_centre", "business_critical", "ccx_managingentity_icare"]
) }}
