...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_calcroutineparamname.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_calcroutineparamname')) }}
FROM {{ ref('v_pctl_calcroutineparamname') }}
