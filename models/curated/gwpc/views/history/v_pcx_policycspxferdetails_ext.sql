...
2026-01-01      0.5                             SCD Type II view over pcx_policycspxferdetails_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('pcx_policycspxferdetails_ext')) }}
    FROM {{ ref('pcx_policycspxferdetails_ext') }}
