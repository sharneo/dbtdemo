...
2026-01-01      0.5                             Curated current-state view for cctl_resourcecontext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cctl_resourcecontext_current')) }}
    FROM {{ ref('dt_cctl_resourcecontext_current') }}
