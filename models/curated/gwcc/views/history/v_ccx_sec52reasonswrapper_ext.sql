...
2026-01-01      0.5                             SCD Type II view over ccx_sec52reasonswrapper_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_sec52reasonswrapper_ext')) }}
    FROM {{ ref('ccx_sec52reasonswrapper_ext') }}
