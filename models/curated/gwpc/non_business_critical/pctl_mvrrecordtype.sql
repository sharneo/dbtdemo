...
2026.01.11      0.0                             This Creates a DBT Incremental Model for the Curated Layer
                                                This Model is for the Curated table pctl_mvrrecordtype in Schema gwpc in the Curated Layer 
-#}
...
SELECT
    {{ dbt_utils.star(from=ref('vw_raw_pctl_mvrrecordtype')) }}
FROM {{ ref('vw_raw_pctl_mvrrecordtype') }} AS src
