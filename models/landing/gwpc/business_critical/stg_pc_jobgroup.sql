...
(
            ...
            SELECT
                ...
                data_payload:TotalGroupCostOfClaims_cur::NUMBER AS totalgroupcostofclaims_cur,
                CAST(data_payload:TotalGroupCostOfClaims_amt AS NUMBER(18,2)) AS totalgroupcostofclaims_amt,
                data_payload:GroupCostOfClosedClaims_cur::NUMBER AS groupcostofclosedclaims_cur,
                CAST(data_payload:GroupCostOfClosedClaims_amt AS NUMBER(18,2)) AS groupcostofclosedclaims_amt,
                data_payload:GroupCostOfOpenedClaims_cur::NUMBER AS groupcostofopenedclaims_cur,
                CAST(data_payload:GroupCostOfOpenedClaims_amt AS NUMBER(18,2)) AS groupcostofopenedclaims_amt,
            ...
            SELECT
                ...
                $1:totalgroupcostofclaims_cur::NUMBER AS totalgroupcostofclaims_cur,
                CAST($1:totalgroupcostofclaims_amt AS NUMBER(18,2)) AS totalgroupcostofclaims_amt,
                $1:groupcostofclosedclaims_cur::NUMBER AS groupcostofclosedclaims_cur,
                CAST($1:groupcostofclosedclaims_amt AS NUMBER(18,2)) AS groupcostofclosedclaims_amt,
                $1:groupcostofopenedclaims_cur::NUMBER AS groupcostofopenedclaims_cur,
                CAST($1:groupcostofopenedclaims_amt AS NUMBER(18,2)) AS groupcostofopenedclaims_amt,
    ...
    SELECT
        *,
        ...
        CAST({{ dbt_utils.generate_surrogate_key([
                        ...
                        'policychangetype',
                        'policychangereason',
                        'totalgroupcostofclaims_cur',
                        'totalgroupcostofclaims_amt',
                        'groupcostofclosedclaims_cur',
                        'groupcostofclosedclaims_amt',
                        'groupcostofopenedclaims_cur',
                        'groupcostofopenedclaims_amt'
