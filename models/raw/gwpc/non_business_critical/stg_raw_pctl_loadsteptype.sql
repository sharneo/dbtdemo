...
2026-01-01      0.0                             Incremental staging model for pctl_loadsteptype.
...
{{ config(
    ...
    tags=["raw_layer", "raw_policy_centre", "policy_centre", "non_business_critical", "pctl_loadsteptype"]
) }}
...
(
            ...
            SELECT
                ...
                'AVRO' file_type
            FROM {{ source('gwpc', 'pctl_loadsteptype') }}
