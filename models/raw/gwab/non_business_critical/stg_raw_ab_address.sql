...
2026-01-01      0.0                             Incremental staging model for ab_address.
...
(
            ...
            SELECT
                ...
                CAST(data_payload:ReplacingAddressLinkID::TEXT AS VARCHAR(30)) AS replacingaddresslinkid,
            ...
            SELECT
                ...
                CAST($1:replacingaddresslinkid::TEXT AS VARCHAR(30)) AS replacingaddresslinkid,
