...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_inboundrecord_psc.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_inboundrecord_psc')) }}
FROM {{ ref('v_ccx_inboundrecord_psc') }}
