...
2026-01-01      0.5                             Curated current-state view for bctl_questionsettype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bctl_questionsettype_current')) }}
    FROM {{ ref('dt_bctl_questionsettype_current') }}
