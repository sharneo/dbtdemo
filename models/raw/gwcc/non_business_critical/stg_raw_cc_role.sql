...
2026-01-01      0.0                             Incremental staging model for cc_role.
                                                role_sk: Entity identity surrogate key on PK ('id')
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "non_business_critical", "cc_role"]
) }}
...
(
            ...
            SELECT
                ...
                CAST(data_payload:EdgeRoleID_icare::TEXT AS VARCHAR(30)) AS edgeroleid_icare,
            ...
            SELECT
                ...
                CAST($1:edgeroleid_icare::TEXT AS VARCHAR(30)) AS edgeroleid_icare,
