...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_paymentscheduledafter.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_paymentscheduledafter')) }}
FROM {{ ref('v_bctl_paymentscheduledafter') }}
