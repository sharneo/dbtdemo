...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_contraentryreftransaction.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_contraentryreftransaction')) }}
FROM {{ ref('v_ccx_contraentryreftransaction') }}
