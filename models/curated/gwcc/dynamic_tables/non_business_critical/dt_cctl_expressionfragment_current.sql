...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_expressionfragment.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_expressionfragment')) }}
FROM {{ ref('v_cctl_expressionfragment') }}
