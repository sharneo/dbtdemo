...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_documentstatustype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_documentstatustype')) }}
FROM {{ ref('v_pctl_documentstatustype') }}
