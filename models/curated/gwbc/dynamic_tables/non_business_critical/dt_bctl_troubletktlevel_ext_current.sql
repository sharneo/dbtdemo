...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_troubletktlevel_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_troubletktlevel_ext')) }}
FROM {{ ref('v_bctl_troubletktlevel_ext') }}
