...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_ocrprocess_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_ocrprocess_icare')) }}
FROM {{ ref('v_cctl_ocrprocess_icare') }}
