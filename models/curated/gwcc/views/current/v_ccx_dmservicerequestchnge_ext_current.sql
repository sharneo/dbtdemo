...
2026-01-01      0.5                             Curated current-state view for ccx_dmservicerequestchnge_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_ccx_dmservicerequestchnge_ext_current')) }}
    FROM {{ ref('dt_ccx_dmservicerequestchnge_ext_current') }}
