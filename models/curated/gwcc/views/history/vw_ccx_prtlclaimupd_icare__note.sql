...
2026.01.11      0.0                             This Creates a Current View for the Curated Layer for the Table  
                                                ccx_prtlclaimupd_icare__note . This view contains only the Latest Record Data in the Table
...
SELECT
    {{ dbt_utils.star(from=ref('ccx_prtlclaimupd_icare__note')  ) }}
FROM {{ ref('ccx_prtlclaimupd_icare__note') }}
