...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_rnswreferralstatus_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_rnswreferralstatus_ext')) }}
FROM {{ ref('v_bctl_rnswreferralstatus_ext') }}
