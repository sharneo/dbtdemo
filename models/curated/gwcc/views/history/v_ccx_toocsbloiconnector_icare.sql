...
2026-01-01      0.5                             SCD Type II view over ccx_toocsbloiconnector_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_toocsbloiconnector_icare')) }}
    FROM {{ ref('ccx_toocsbloiconnector_icare') }}
