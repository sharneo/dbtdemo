...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_depositfrequency.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_depositfrequency')) }}
FROM {{ ref('v_pctl_depositfrequency') }}
