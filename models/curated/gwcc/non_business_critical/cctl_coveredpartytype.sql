...
2026.01.11      0.0                             This Creates a DBT Incremental Model for the Curated Layer
                                                This Model is for the Curated table cctl_coveredpartytype in Schema gwcc in the Curated Layer 
-#}
...
SELECT
    {{ dbt_utils.star(from=ref('vw_raw_cctl_coveredpartytype')) }}
FROM {{ ref('vw_raw_cctl_coveredpartytype') }} AS src
