...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_monetaryoridecurrency_sp.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_monetaryoridecurrency_sp')) }}
FROM {{ ref('v_bctl_monetaryoridecurrency_sp') }}
