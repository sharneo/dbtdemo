...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_essentialservicetype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_essentialservicetype')) }}
FROM {{ ref('v_cctl_essentialservicetype') }}
