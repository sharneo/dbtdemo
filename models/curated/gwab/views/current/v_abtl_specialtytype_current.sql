...
2026-01-01      0.5                             Curated current-state view for abtl_specialtytype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_abtl_specialtytype_current')) }}
    FROM {{ ref('dt_abtl_specialtytype_current') }}
