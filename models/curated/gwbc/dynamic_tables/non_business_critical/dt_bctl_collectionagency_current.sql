...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_collectionagency.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_collectionagency')) }}
FROM {{ ref('v_bctl_collectionagency') }}
