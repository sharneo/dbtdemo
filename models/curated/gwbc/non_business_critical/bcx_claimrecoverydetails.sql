...
2026.01.11      0.0                             This Creates a DBT Incremental Model for the Curated Layer
                                                This Model is for the Curated table bcx_claimrecoverydetails in Schema gwbc in the Curated Layer 
-#}
...
SELECT
    {{ dbt_utils.star(from=ref('vw_raw_bcx_claimrecoverydetails')) }}
FROM {{ ref('vw_raw_bcx_claimrecoverydetails') }} AS src
