...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_rowuniformitystatus.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_rowuniformitystatus')) }}
FROM {{ ref('v_pctl_rowuniformitystatus') }}
