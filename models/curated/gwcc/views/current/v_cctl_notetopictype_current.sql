...
2026-01-01      0.5                             Curated current-state view for cctl_notetopictype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cctl_notetopictype_current')) }}
    FROM {{ ref('dt_cctl_notetopictype_current') }}
