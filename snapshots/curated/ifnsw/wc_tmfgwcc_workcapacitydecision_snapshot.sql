{% snapshot wc_tmfgwcc_workcapacitydecision_snapshot %}
...
2026.01.11      0.0                             This Creates a  View for the Snapshot for the Table wc_tmfgwcc_workcapacitydecision_snapshot . 
...
{{ config(
    ...
    unique_key='wc_tmfgwcc_workcapacitydecision_sk',
    strategy='check',
    alias='wc_tmfgwcc_workcapacitydecision',
    ...
    tags=['snapshot_tmf','snapshot_curated','snapshot','wc_tmfgwcc_workcapacitydecision']
) }}
...
WITH source_data AS (
    ...
    ]) }} AS wc_tmfgwcc_workcapacitydecision_sk,
        claims_manager,
        line_of_business,
        extract_date,
        record_number,
    ...
    FROM {{ source('ifnsw_claim_interface', 'wc_tmfgwcc_workcapacitydecision') }}
)
