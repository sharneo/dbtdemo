...
2026-01-01      0.0                             Curated current-state view for ab_abcontactaddress.
...
{{ config(
    materialized='view',
    tags=["curated", "curated_view", "curated_current", "contact_manager", "non_business_critical", "ab_abcontactaddress"]
) }}
