...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_uwapprovaldurationtype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_uwapprovaldurationtype')) }}
FROM {{ ref('v_pctl_uwapprovaldurationtype') }}
