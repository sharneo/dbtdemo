...
2026-01-01      0.5                             SCD Type II view over pcx_managingentityonpol_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('pcx_managingentityonpol_icare')) }}
    FROM {{ ref('pcx_managingentityonpol_icare') }}
