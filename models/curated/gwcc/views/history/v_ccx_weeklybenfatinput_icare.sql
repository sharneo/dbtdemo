...
2026-01-01      0.5                             SCD Type II view over ccx_weeklybenfatinput_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_weeklybenfatinput_icare')) }}
    FROM {{ ref('ccx_weeklybenfatinput_icare') }}
