...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_statementbilledworkitem.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_statementbilledworkitem')) }}
FROM {{ ref('v_bctl_statementbilledworkitem') }}
