...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_refdatetypelookup.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_refdatetypelookup')) }}
FROM {{ ref('v_pctl_refdatetypelookup') }}
