...
2026-01-01      0.0                             Curated SCD2 full history view for pctl_effectivenessgrade.
...
{{ config(
    materialized='view',
    tags=["curated", "curated_view", "curated_history", "policy_centre", "non_business_critical", "pctl_effectivenessgrade"]
) }}
