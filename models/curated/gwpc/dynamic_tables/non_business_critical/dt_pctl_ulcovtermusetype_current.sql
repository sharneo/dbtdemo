...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_ulcovtermusetype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_ulcovtermusetype')) }}
FROM {{ ref('v_pctl_ulcovtermusetype') }}
