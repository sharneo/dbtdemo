...
2026-01-01      0.5                             Curated current-state view for bctl_writeofftype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bctl_writeofftype_current')) }}
    FROM {{ ref('dt_bctl_writeofftype_current') }}
