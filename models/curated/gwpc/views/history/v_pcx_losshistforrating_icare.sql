...
2026-01-01      0.5                             SCD Type II view over pcx_losshistforrating_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('pcx_losshistforrating_icare')) }}
    FROM {{ ref('pcx_losshistforrating_icare') }}
