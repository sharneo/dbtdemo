...
2026-01-01      0.0                             Incremental staging model for cc_servreqmsg.
                                                servreqmsg_sk: Entity identity surrogate key on PK ('id')
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "non_business_critical", "cc_servreqmsg"]
) }}
...
(
            ...
            SELECT
                ...
                data_payload:SentFromPortal::BOOLEAN AS sentfromportal,
                data_payload:UpdateUserID::NUMBER AS updateuserid,
                data_payload:ServiceRequestID::NUMBER AS servicerequestid,
                TO_TIMESTAMP_TZ(data_payload:SendDate::NUMBER/1000) AS senddate,
                ...
                'AVRO' file_type
            FROM {{ source('gwcc', 'cc_servreqmsg') }}
            ...
            SELECT
                ...
                $1:sentfromportal::BOOLEAN AS sentfromportal,
                $1:updateuserid::NUMBER AS updateuserid,
                $1:servicerequestid::NUMBER AS servicerequestid,
                $1:senddate::TIMESTAMP_TZ AS senddate,
    ...
    SELECT
        *,
        CAST({{ dbt_utils.generate_surrogate_key([
            'id'
        ]) }} AS VARCHAR(150)) AS servreqmsg_sk,
        CAST({{ dbt_utils.generate_surrogate_key([
                        'body',
                        'createuserid',
                        'publicid',
