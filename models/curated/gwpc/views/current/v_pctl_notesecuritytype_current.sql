...
2026-01-01      0.5                             Curated current-state view for pctl_notesecuritytype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_notesecuritytype_current')) }}
    FROM {{ ref('dt_pctl_notesecuritytype_current') }}
