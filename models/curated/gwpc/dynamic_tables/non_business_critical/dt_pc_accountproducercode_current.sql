...
2026-01-01      0.5                             Dynamic Table for current-state of pc_accountproducercode.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pc_accountproducercode')) }}
FROM {{ ref('v_pc_accountproducercode') }}
