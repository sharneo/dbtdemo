...
2026-01-01      0.5                             Curated current-state view for pctl_ratetabledatatype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_ratetabledatatype_current')) }}
    FROM {{ ref('dt_pctl_ratetabledatatype_current') }}
