...
2026-01-01      0.5                             Curated current-state view for ccx_garnisheeorder_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_ccx_garnisheeorder_icare_current')) }}
    FROM {{ ref('dt_ccx_garnisheeorder_icare_current') }}
