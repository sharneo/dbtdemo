...
2026-01-01      0.0                             Incremental staging model for cc_policyperiod.
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "non_business_critical", "cc_policyperiod"]
) }}
...
(
            ...
            SELECT
                ...
                data_payload:PolicyPeriodType::NUMBER AS policyperiodtype,
                ...
                'AVRO' file_type
            FROM {{ source('gwcc', 'cc_policyperiod') }}
            ...
            SELECT
                ...
                $1:policyperiodtype::NUMBER AS policyperiodtype,
