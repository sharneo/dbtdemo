...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_plcycorrespondencetype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_plcycorrespondencetype')) }}
FROM {{ ref('v_bctl_plcycorrespondencetype') }}
