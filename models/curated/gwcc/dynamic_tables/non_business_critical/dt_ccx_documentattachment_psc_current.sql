...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_documentattachment_psc.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_documentattachment_psc')) }}
FROM {{ ref('v_ccx_documentattachment_psc') }}
