...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_sec52reasndecisionrev_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_sec52reasndecisionrev_ext')) }}
FROM {{ ref('v_ccx_sec52reasndecisionrev_ext') }}
