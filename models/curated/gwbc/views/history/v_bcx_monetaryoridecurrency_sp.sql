...
2026-01-01      0.5                             SCD Type II view over bcx_monetaryoridecurrency_sp.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('bcx_monetaryoridecurrency_sp')) }}
    FROM {{ ref('bcx_monetaryoridecurrency_sp') }}
