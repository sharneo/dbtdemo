...
2026-01-01      0.5                             Curated current-state view for bctl_compliancestatus.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bctl_compliancestatus_current')) }}
    FROM {{ ref('dt_bctl_compliancestatus_current') }}
