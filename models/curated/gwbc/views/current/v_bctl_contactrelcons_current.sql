...
2026-01-01      0.5                             Curated current-state view for bctl_contactrelcons.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bctl_contactrelcons_current')) }}
    FROM {{ ref('dt_bctl_contactrelcons_current') }}
