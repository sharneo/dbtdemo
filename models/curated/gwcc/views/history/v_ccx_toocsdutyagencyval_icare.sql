...
2026-01-01      0.5                             SCD Type II view over ccx_toocsdutyagencyval_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_toocsdutyagencyval_icare')) }}
    FROM {{ ref('ccx_toocsdutyagencyval_icare') }}
