...
2026-01-01      0.5                             Curated current-state view for pc_activitypattern.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pc_activitypattern_current')) }}
    FROM {{ ref('dt_pc_activitypattern_current') }}
