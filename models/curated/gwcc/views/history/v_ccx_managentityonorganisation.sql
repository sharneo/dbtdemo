...
2026-01-01      0.5                             SCD Type II view over ccx_managentityonorganisation.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_managentityonorganisation')) }}
    FROM {{ ref('ccx_managentityonorganisation') }}
