...
2026-01-01      0.5                             Dynamic Table for current-state of pcx_inboundsubrecord_psc.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pcx_inboundsubrecord_psc')) }}
FROM {{ ref('v_pcx_inboundsubrecord_psc') }}
