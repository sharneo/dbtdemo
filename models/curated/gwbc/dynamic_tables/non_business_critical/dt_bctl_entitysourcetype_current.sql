...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_entitysourcetype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_entitysourcetype')) }}
FROM {{ ref('v_bctl_entitysourcetype') }}
