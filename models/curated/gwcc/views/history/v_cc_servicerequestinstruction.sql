...
2026-01-01      0.5                             SCD Type II view over cc_servicerequestinstruction.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('cc_servicerequestinstruction')) }}
    FROM {{ ref('cc_servicerequestinstruction') }}
