...
2026-01-01      0.5                             SCD Type II view over ccx_disputerevreqwrap_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_disputerevreqwrap_icare')) }}
    FROM {{ ref('ccx_disputerevreqwrap_icare') }}
