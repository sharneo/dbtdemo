...
2026-01-01      0.5                             SCD Type II view over ccx_paygsupplierpayer_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_paygsupplierpayer_icare')) }}
    FROM {{ ref('ccx_paygsupplierpayer_icare') }}
