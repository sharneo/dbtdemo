...
2026.01.11      0.0                             This Creates a Current View for the Curated Layer for the Table  
                                                ccx_know_article_ref_data_ext . This view contains only the Latest Record Data in the Table
...
SELECT
    {{ dbt_utils.star(from=ref('ccx_know_article_ref_data_ext')  ) }}
FROM {{ ref('ccx_know_article_ref_data_ext') }}
