...
2026-01-01      0.5                             SCD Type II view over ccx_externalidentifier_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_externalidentifier_icare')) }}
    FROM {{ ref('ccx_externalidentifier_icare') }}
