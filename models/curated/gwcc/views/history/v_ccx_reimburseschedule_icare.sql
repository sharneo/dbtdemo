...
2026-01-01      0.5                             SCD Type II view over ccx_reimburseschedule_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_reimburseschedule_icare')) }}
    FROM {{ ref('ccx_reimburseschedule_icare') }}
