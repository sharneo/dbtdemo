...
2026-01-01      0.5                             Curated current-state view for cc_policylocation.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cc_policylocation_current')) }}
    FROM {{ ref('dt_cc_policylocation_current') }}
