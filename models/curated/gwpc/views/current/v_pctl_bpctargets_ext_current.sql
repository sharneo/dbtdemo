...
2026-01-01      0.0                             Curated current-state view for pctl_bpctargets_ext.
...
{{ config(
    materialized='view',
    tags=["curated", "curated_view", "curated_current", "policy_centre", "non_business_critical", "pctl_bpctargets_ext"]
) }}
