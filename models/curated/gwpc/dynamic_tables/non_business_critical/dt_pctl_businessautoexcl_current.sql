...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_businessautoexcl.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_businessautoexcl')) }}
FROM {{ ref('v_pctl_businessautoexcl') }}
