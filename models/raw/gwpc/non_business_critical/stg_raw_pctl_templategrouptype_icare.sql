...
2026-01-01      0.0                             Incremental staging model for pctl_templategrouptype_icare.
...
{{ config(
    ...
    tags=["raw_layer", "raw_policy_centre", "policy_centre", "non_business_critical", "pctl_templategrouptype_icare"]
) }}
...
(
            ...
            SELECT
                ...
                'AVRO' file_type
            FROM {{ source('gwpc', 'pctl_templategrouptype_icare') }}
