...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_ongoingreserveweeks_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_ongoingreserveweeks_icare')) }}
FROM {{ ref('v_cctl_ongoingreserveweeks_icare') }}
