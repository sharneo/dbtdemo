...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_wpireviewoutcometype_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_wpireviewoutcometype_ext')) }}
FROM {{ ref('v_cctl_wpireviewoutcometype_ext') }}
