...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_dbupdatestatsrunnertype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_dbupdatestatsrunnertype')) }}
FROM {{ ref('v_bctl_dbupdatestatsrunnertype') }}
