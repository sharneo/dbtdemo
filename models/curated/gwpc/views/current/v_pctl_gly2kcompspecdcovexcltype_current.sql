...
2026-01-01      0.5                             Curated current-state view for pctl_gly2kcompspecdcovexcltype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_gly2kcompspecdcovexcltype_current')) }}
    FROM {{ ref('dt_pctl_gly2kcompspecdcovexcltype_current') }}
