...
2026-01-01      0.5                             SCD Type II view over ccx_documentsearchrecord_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_documentsearchrecord_ext')) }}
    FROM {{ ref('ccx_documentsearchrecord_ext') }}
