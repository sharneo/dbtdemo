{% snapshot acct_doc_header_snapshot%}
...
2026-01-01      0.0                             This creates a SCD Type 2 Record for the Data in the RAW Table . This will run for ACCT_DOC_HEADER
...
{{ config(
    ...
    tags=['sap','snapshot','acct_doc_header_snapshot']
) }}
