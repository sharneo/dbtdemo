...
2026.01.11      0.0                             This Creates an Estimates Recoveries View for SIRA Reporting  
...
cctl_costcategory as (
    ...
    where typecode in ('70', '71', '72', '73', '74', '75', '76', '77')
),
...
combined as (
    select
        ...
        cast('RECOVERIES' as varchar(100)) as transactiontype,
    ...
    select
        ...
        costcategoryname,
        cast(subtype as varchar(10)) as transactionsubtype,
        cast('RECOVERY_RESERVES' as varchar(100)) as transactiontype,
        transactiondateyyyymm,
        updatetime as transactiondate,
        cast(transactionamount as decimal(20, 2)) as transactionamount,
        startdate,
