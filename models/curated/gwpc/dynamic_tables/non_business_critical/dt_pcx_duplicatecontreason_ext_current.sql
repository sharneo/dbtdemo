...
2026-01-01      0.5                             Dynamic Table for current-state of pcx_duplicatecontreason_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pcx_duplicatecontreason_ext')) }}
FROM {{ ref('v_pcx_duplicatecontreason_ext') }}
