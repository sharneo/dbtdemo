...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_contactlinkstatustype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_contactlinkstatustype')) }}
FROM {{ ref('v_pctl_contactlinkstatustype') }}
