...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_inboundfiletype_psc.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_inboundfiletype_psc')) }}
FROM {{ ref('v_cctl_inboundfiletype_psc') }}
