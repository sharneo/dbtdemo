...
2026-01-01      0.5                             Curated current-state view for bctl_statementdueworkitem.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bctl_statementdueworkitem_current')) }}
    FROM {{ ref('dt_bctl_statementdueworkitem_current') }}
