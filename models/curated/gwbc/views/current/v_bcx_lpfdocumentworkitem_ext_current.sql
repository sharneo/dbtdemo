...
2026-01-01      0.5                             Curated current-state view for bcx_lpfdocumentworkitem_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bcx_lpfdocumentworkitem_ext_current')) }}
    FROM {{ ref('dt_bcx_lpfdocumentworkitem_ext_current') }}
