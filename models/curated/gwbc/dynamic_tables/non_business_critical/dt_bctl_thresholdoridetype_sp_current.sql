...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_thresholdoridetype_sp.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_thresholdoridetype_sp')) }}
FROM {{ ref('v_bctl_thresholdoridetype_sp') }}
