...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_writeoffreversalreason.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_writeoffreversalreason')) }}
FROM {{ ref('v_bctl_writeoffreversalreason') }}
