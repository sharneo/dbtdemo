...
2026-01-01      0.5                             SCD Type II view over ccx_claimscostscdeexclude_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_claimscostscdeexclude_ext')) }}
    FROM {{ ref('ccx_claimscostscdeexclude_ext') }}
