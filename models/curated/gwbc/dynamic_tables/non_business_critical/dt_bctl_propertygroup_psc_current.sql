...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_propertygroup_psc.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_propertygroup_psc')) }}
FROM {{ ref('v_bctl_propertygroup_psc') }}
