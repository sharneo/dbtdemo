...
2026-01-01      0.0                             Incremental staging model for ccx_workstatushistory_icare.
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "business_critical", "ccx_workstatushistory_icare"]
) }}
...
(
            ...
            SELECT
                ...
                CAST(data_payload:Operation::TEXT AS VARCHAR(15)) AS operation,
                data_payload:BeanVersion::NUMBER AS beanversion,
                data_payload:ArchivePartition::NUMBER AS archivepartition,
                data_payload:Retired::NUMBER AS retired,
                TO_TIMESTAMP_TZ(data_payload:CreateTime::NUMBER/1000) AS createtime,
                data_payload:WageLoss::BOOLEAN AS wageloss,
                ...
                'AVRO' file_type
            FROM {{ source('gwcc', 'ccx_workstatushistory_icare') }}
            ...
            SELECT
                ...
                CAST($1:operation::TEXT AS VARCHAR(15)) AS operation,
                $1:beanversion::NUMBER AS beanversion,
                $1:archivepartition::NUMBER AS archivepartition,
                $1:retired::NUMBER AS retired,
                $1:createtime::TIMESTAMP_TZ AS createtime,
                $1:wageloss::BOOLEAN AS wageloss,
