...
2026-01-01      0.5                             Curated current-state view for cc_contactfingerprint.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cc_contactfingerprint_current')) }}
    FROM {{ ref('dt_cc_contactfingerprint_current') }}
