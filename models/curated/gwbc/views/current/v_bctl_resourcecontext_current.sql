...
2026-01-01      0.5                             Curated current-state view for bctl_resourcecontext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bctl_resourcecontext_current')) }}
    FROM {{ ref('dt_bctl_resourcecontext_current') }}
