...
2026-01-01      0.0                             Curated current-state view for cctl_subrogationview.
...
{{ config(
    materialized='view',
    tags=["curated", "curated_view", "curated_current", "claim_centre", "non_business_critical", "cctl_subrogationview"]
) }}
