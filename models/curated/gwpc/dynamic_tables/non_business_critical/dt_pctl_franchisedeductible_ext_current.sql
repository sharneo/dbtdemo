...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_franchisedeductible_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_franchisedeductible_ext')) }}
FROM {{ ref('v_pctl_franchisedeductible_ext') }}
