...
2026-01-01      0.0                             Incremental staging model for cctl_cts_ref_sportinginjury.
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "non_business_critical", "cctl_cts_ref_sportinginjury"]
) }}
...
(
            ...
            SELECT
                ...
                'AVRO' file_type
            FROM {{ source('gwcc', 'cctl_cts_ref_sportinginjury') }}
