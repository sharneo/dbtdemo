...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_templatestatus_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_templatestatus_icare')) }}
FROM {{ ref('v_bctl_templatestatus_icare') }}
