...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_userattributetype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_userattributetype')) }}
FROM {{ ref('v_pctl_userattributetype') }}
