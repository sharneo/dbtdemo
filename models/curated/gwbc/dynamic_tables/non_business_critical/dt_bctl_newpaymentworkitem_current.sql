...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_newpaymentworkitem.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_newpaymentworkitem')) }}
FROM {{ ref('v_bctl_newpaymentworkitem') }}
