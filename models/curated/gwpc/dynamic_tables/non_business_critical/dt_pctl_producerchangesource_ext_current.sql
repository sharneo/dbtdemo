...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_producerchangesource_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_producerchangesource_ext')) }}
FROM {{ ref('v_pctl_producerchangesource_ext') }}
