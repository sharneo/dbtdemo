...
2026-01-01      0.5                             Curated current-state view for pctl_employeeclass.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_employeeclass_current')) }}
    FROM {{ ref('dt_pctl_employeeclass_current') }}
