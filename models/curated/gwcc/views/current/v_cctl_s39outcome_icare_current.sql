...
2026-01-01      0.5                             Curated current-state view for cctl_s39outcome_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cctl_s39outcome_icare_current')) }}
    FROM {{ ref('dt_cctl_s39outcome_icare_current') }}
