...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_mattermethodserved.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_mattermethodserved')) }}
FROM {{ ref('v_cctl_mattermethodserved') }}
