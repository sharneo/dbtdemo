...
2026-01-01      0.0                             Incremental staging model for pc_user.
...
{{ config(
    ...
    tags=["raw_layer", "raw_policy_centre", "policy_centre", "business_critical", "pc_user"]
) }}
...
(
            ...
            SELECT
                ...
                data_payload:UserType::NUMBER AS usertype,
                data_payload:UseProducerCodeSecurity::BOOLEAN AS useproducercodesecurity,
                ...
                data_payload:UseOrgAddress::BOOLEAN AS useorgaddress,
                ...
                'AVRO' file_type
            FROM {{ source('gwpc', 'pc_user') }}
            WHERE REGEXP_SUBSTR(metadata_file_name, '[^.]+$') = 'avro'
            UNION ALL 
            SELECT
                $1:loadcommandid::NUMBER AS loadcommandid,
                CAST($1:publicid::TEXT AS VARCHAR(64)) AS publicid,
                $1:usertype::NUMBER AS usertype,
                $1:useproducercodesecurity::BOOLEAN AS useproducercodesecurity,
                ...
                $1:useorgaddress::BOOLEAN AS useorgaddress,
