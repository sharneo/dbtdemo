...
2026-01-01      0.0                             Curated current-state view for bctl_prodcorrespondencetype.
...
{{ config(
    materialized='view',
    tags=["curated", "curated_view", "curated_current", "billing_centre", "non_business_critical", "bctl_prodcorrespondencetype"]
) }}
