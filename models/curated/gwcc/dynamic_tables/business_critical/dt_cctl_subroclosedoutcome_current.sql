...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_subroclosedoutcome.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_subroclosedoutcome')) }}
FROM {{ ref('v_cctl_subroclosedoutcome') }}
