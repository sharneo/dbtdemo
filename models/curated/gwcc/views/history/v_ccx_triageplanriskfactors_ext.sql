...
2026-01-01      0.5                             SCD Type II view over ccx_triageplanriskfactors_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_triageplanriskfactors_ext')) }}
    FROM {{ ref('ccx_triageplanriskfactors_ext') }}
