...
2026-01-01      0.5                             Dynamic Table for current-state of pcx_crifpolicydm_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pcx_crifpolicydm_icare')) }}
FROM {{ ref('v_pcx_crifpolicydm_icare') }}
