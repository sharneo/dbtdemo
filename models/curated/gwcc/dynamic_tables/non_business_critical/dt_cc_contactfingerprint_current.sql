...
2026-01-01      0.5                             Dynamic Table for current-state of cc_contactfingerprint.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cc_contactfingerprint')) }}
FROM {{ ref('v_cc_contactfingerprint') }}
