...
2026-01-01      0.5                             Dynamic Table for current-state of abtl_paymentmethod_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_abtl_paymentmethod_icare')) }}
FROM {{ ref('v_abtl_paymentmethod_icare') }}
