...
2026-01-01      0.5                             SCD Type II view over ccx_piawecheckindexation_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_piawecheckindexation_ext')) }}
    FROM {{ ref('ccx_piawecheckindexation_ext') }}
