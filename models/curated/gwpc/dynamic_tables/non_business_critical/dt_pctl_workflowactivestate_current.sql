...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_workflowactivestate.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_workflowactivestate')) }}
FROM {{ ref('v_pctl_workflowactivestate') }}
