...
2026-01-01      0.5                             Dynamic Table for current-state of pc_accountcontactrole.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pc_accountcontactrole')) }}
FROM {{ ref('v_pc_accountcontactrole') }}
