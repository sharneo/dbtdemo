...
2026-01-01      0.5                             Dynamic Table for current-state of pc_paymentplansummary.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pc_paymentplansummary')) }}
FROM {{ ref('v_pc_paymentplansummary') }}
