...
2026-01-01      0.5                             SCD Type II view over ccx_significantlitind_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_significantlitind_icare')) }}
    FROM {{ ref('ccx_significantlitind_icare') }}
