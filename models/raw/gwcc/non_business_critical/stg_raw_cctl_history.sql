...
2026-01-01      0.0                             Incremental staging model for cctl_history.
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "non_business_critical", "cctl_history"]
) }}
