...
2026-01-01      0.0                             Incremental staging model for cctl_primaryphonetype.
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "business_critical", "cctl_primaryphonetype"]
) }}
...
(
            ...
            SELECT
                ...
                'AVRO' file_type
            FROM {{ source('gwcc', 'cctl_primaryphonetype') }}
