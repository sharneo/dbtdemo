...
2026-01-01      0.5                             Curated current-state view for abx_accreditation.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_abx_accreditation_current')) }}
    FROM {{ ref('dt_abx_accreditation_current') }}
