...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_acctcorrespondencetype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_acctcorrespondencetype')) }}
FROM {{ ref('v_bctl_acctcorrespondencetype') }}
