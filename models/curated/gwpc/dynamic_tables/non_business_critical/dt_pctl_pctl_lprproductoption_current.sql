...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_pctl_lprproductoption.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_pctl_lprproductoption')) }}
FROM {{ ref('v_pctl_pctl_lprproductoption') }}
