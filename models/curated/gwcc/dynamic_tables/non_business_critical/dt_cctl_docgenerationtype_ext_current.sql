...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_docgenerationtype_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_docgenerationtype_ext')) }}
FROM {{ ref('v_cctl_docgenerationtype_ext') }}
