...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_creditcardissuer.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_creditcardissuer')) }}
FROM {{ ref('v_pctl_creditcardissuer') }}
