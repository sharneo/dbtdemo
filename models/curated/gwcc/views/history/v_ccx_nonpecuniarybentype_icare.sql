...
2026-01-01      0.5                             SCD Type II view over ccx_nonpecuniarybentype_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_nonpecuniarybentype_icare')) }}
    FROM {{ ref('ccx_nonpecuniarybentype_icare') }}
