...
2026-01-01      0.5                             Dynamic Table for current-state of bcx_claimrecoverydetails.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bcx_claimrecoverydetails')) }}
FROM {{ ref('v_bcx_claimrecoverydetails') }}
