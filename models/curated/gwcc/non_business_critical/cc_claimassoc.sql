...
2026.01.11      0.0                             This Creates a DBT Incremental Model for the Curated Layer
                                                This Model is for the Curated table cc_claimassoc in Schema gwcc in the Curated Layer 
-#}
...
SELECT
    {{ dbt_utils.star(from=ref('vw_raw_cc_claimassoc')) }}
FROM {{ ref('vw_raw_cc_claimassoc') }} AS src
