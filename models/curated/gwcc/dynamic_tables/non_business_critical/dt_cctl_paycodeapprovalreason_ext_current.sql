...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_paycodeapprovalreason_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_paycodeapprovalreason_ext')) }}
FROM {{ ref('v_cctl_paycodeapprovalreason_ext') }}
