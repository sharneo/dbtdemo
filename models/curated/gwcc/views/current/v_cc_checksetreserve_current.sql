...
2026-01-01      0.5                             Curated current-state view for cc_checksetreserve.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cc_checksetreserve_current')) }}
    FROM {{ ref('dt_cc_checksetreserve_current') }}
