...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_bctl_lprproductoption.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_bctl_lprproductoption')) }}
FROM {{ ref('v_bctl_bctl_lprproductoption') }}
