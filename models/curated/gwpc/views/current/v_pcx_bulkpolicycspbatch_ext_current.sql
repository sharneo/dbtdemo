...
2026-01-01      0.5                             Curated current-state view for pcx_bulkpolicycspbatch_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pcx_bulkpolicycspbatch_ext_current')) }}
    FROM {{ ref('dt_pcx_bulkpolicycspbatch_ext_current') }}
