...
2026-01-01      0.0                             Incremental staging model for ccx_dmservicerequestchnge_ext.
                                                dmservicerequestchnge_ext_sk: Entity identity surrogate key on PK ('id')
...
{{ config(
    ...
    tags=["raw_layer", "raw_claim_centre", "claim_centre", "non_business_critical", "ccx_dmservicerequestchnge_ext"]
) }}
...
(
            ...
            SELECT
                ...
                data_payload:DMServiceRequestIns::NUMBER AS dmservicerequestins,
                ...
                'AVRO' file_type
            FROM {{ source('gwcc', 'ccx_dmservicerequestchnge_ext') }}
            ...
            SELECT
                ...
                $1:dmservicerequestins::NUMBER AS dmservicerequestins,
    ...
    SELECT
        *,
        CAST({{ dbt_utils.generate_surrogate_key([
            'id'
        ]) }} AS VARCHAR(150)) AS dmservicerequestchnge_ext_sk,
        CAST({{ dbt_utils.generate_surrogate_key([
                        'loadcommandid',
                        'sequence',
