...
2026-01-01      0.5                             Dynamic Table for current-state of bcx_bizruleoverrides_sp.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bcx_bizruleoverrides_sp')) }}
FROM {{ ref('v_bcx_bizruleoverrides_sp') }}
