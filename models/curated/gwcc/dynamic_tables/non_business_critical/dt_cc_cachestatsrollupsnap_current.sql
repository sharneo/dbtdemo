...
2026-01-01      0.5                             Dynamic Table for current-state of cc_cachestatsrollupsnap.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cc_cachestatsrollupsnap')) }}
FROM {{ ref('v_cc_cachestatsrollupsnap') }}
