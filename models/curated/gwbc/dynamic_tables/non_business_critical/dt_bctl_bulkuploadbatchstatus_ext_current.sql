...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_bulkuploadbatchstatus_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_bulkuploadbatchstatus_ext')) }}
FROM {{ ref('v_bctl_bulkuploadbatchstatus_ext') }}
