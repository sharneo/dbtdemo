...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_cts_schedule3item.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_cts_schedule3item')) }}
FROM {{ ref('v_cctl_cts_schedule3item') }}
