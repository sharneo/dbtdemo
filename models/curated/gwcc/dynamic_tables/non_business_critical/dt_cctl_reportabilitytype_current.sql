...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_reportabilitytype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_reportabilitytype')) }}
FROM {{ ref('v_cctl_reportabilitytype') }}
