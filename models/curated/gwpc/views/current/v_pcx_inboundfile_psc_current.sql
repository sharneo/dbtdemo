...
2026-01-01      0.5                             Curated current-state view for pcx_inboundfile_psc.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pcx_inboundfile_psc_current')) }}
    FROM {{ ref('dt_pcx_inboundfile_psc_current') }}
