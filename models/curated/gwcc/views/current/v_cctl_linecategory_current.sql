...
2026-01-01      0.5                             Curated current-state view for cctl_linecategory.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cctl_linecategory_current')) }}
    FROM {{ ref('dt_cctl_linecategory_current') }}
