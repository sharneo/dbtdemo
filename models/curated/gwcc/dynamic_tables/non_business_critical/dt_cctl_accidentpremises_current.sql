...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_accidentpremises.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_accidentpremises')) }}
FROM {{ ref('v_cctl_accidentpremises') }}
