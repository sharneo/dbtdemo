...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_customconditiontype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_customconditiontype')) }}
FROM {{ ref('v_cctl_customconditiontype') }}
