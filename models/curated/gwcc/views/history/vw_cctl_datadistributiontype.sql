...
2026.01.11      0.0                             This Creates a Current View for the Curated Layer for the Table  
                                                cctl_datadistributiontype . This view contains only the Latest Record Data in the Table
...
SELECT
    {{ dbt_utils.star(from=ref('cctl_datadistributiontype')  ) }}
FROM {{ ref('cctl_datadistributiontype') }}
