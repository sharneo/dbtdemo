...
2026-01-01      0.5                             Curated current-state view for bctl_loaderrortype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bctl_loaderrortype_current')) }}
    FROM {{ ref('dt_bctl_loaderrortype_current') }}
