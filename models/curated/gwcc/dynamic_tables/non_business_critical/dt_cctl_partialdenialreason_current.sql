...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_partialdenialreason.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_partialdenialreason')) }}
FROM {{ ref('v_cctl_partialdenialreason') }}
