...
2026-01-01      0.5                             SCD Type II view over ccx_claimtransferdetails_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_claimtransferdetails_ext')) }}
    FROM {{ ref('ccx_claimtransferdetails_ext') }}
