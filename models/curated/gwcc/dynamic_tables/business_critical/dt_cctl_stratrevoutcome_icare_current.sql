...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_stratrevoutcome_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_stratrevoutcome_icare')) }}
FROM {{ ref('v_cctl_stratrevoutcome_icare') }}
