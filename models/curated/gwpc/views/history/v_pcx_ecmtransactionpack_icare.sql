...
2026-01-01      0.5                             SCD Type II view over pcx_ecmtransactionpack_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('pcx_ecmtransactionpack_icare')) }}
    FROM {{ ref('pcx_ecmtransactionpack_icare') }}
