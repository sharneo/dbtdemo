...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_lostwagesbenefittype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_lostwagesbenefittype')) }}
FROM {{ ref('v_cctl_lostwagesbenefittype') }}
