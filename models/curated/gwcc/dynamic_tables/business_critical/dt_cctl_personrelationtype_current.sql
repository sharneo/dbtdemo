...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_personrelationtype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_personrelationtype')) }}
FROM {{ ref('v_cctl_personrelationtype') }}
