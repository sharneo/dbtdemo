...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_forminferencetime.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_forminferencetime')) }}
FROM {{ ref('v_pctl_forminferencetime') }}
