...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_ruleexportimporttask.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_ruleexportimporttask')) }}
FROM {{ ref('v_pctl_ruleexportimporttask') }}
