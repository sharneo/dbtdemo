...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_y2kexclusiontype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_y2kexclusiontype')) }}
FROM {{ ref('v_pctl_y2kexclusiontype') }}
