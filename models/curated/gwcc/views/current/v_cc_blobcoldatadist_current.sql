...
2026-01-01      0.5                             Curated current-state view for cc_blobcoldatadist.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cc_blobcoldatadist_current')) }}
    FROM {{ ref('dt_cc_blobcoldatadist_current') }}
