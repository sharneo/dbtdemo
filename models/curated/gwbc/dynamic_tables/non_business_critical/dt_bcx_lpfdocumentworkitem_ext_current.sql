...
2026-01-01      0.5                             Dynamic Table for current-state of bcx_lpfdocumentworkitem_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bcx_lpfdocumentworkitem_ext')) }}
FROM {{ ref('v_bcx_lpfdocumentworkitem_ext') }}
