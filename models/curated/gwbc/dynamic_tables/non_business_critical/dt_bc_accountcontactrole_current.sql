...
2026-01-01      0.5                             Dynamic Table for current-state of bc_accountcontactrole.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bc_accountcontactrole')) }}
FROM {{ ref('v_bc_accountcontactrole') }}
