...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_cts_ref_lumpsumpymt.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_cts_ref_lumpsumpymt')) }}
FROM {{ ref('v_ccx_cts_ref_lumpsumpymt') }}
