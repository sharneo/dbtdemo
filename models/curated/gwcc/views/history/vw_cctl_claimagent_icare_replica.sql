...
2026.01.11      0.0                             This Creates a Current View for the Curated Layer for the Table  
                                                cctl_claimagent_icare_replica . This view contains only the Latest Record Data in the Table
...
SELECT
    {{ dbt_utils.star(from=ref('cctl_claimagent_icare_replica')  ) }}
FROM {{ ref('cctl_claimagent_icare_replica') }}
