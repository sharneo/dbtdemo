...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_templategrouptype_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_templategrouptype_icare')) }}
FROM {{ ref('v_bctl_templategrouptype_icare') }}
