...
2026-01-01      0.5                             SCD Type II view over ccx_cts_nonpecuniarybenefits.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_cts_nonpecuniarybenefits')) }}
    FROM {{ ref('ccx_cts_nonpecuniarybenefits') }}
