...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_waitingperiodtype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_waitingperiodtype')) }}
FROM {{ ref('v_cctl_waitingperiodtype') }}
