...
2026-01-01      0.5                             Curated current-state view for ccx_counsel_icareid.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_ccx_counsel_icareid_current')) }}
    FROM {{ ref('dt_ccx_counsel_icareid_current') }}
