...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_cts_ref_permanentimpts.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_cts_ref_permanentimpts')) }}
FROM {{ ref('v_cctl_cts_ref_permanentimpts') }}
