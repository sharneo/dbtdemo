...
(
            ...
            SELECT
                ...
                data_payload:RecoveryReserve_ExtID::NUMBER AS recoveryreserve_extid,
                data_payload:RecoveryInvoice_ExtID::NUMBER AS recoveryinvoice_extid,
            ...
            SELECT
                ...
                $1:recoveryreserve_extid::NUMBER AS recoveryreserve_extid,
                $1:recoveryinvoice_extid::NUMBER AS recoveryinvoice_extid,
    ...
    SELECT
        *,
        ...
        CAST({{ dbt_utils.generate_surrogate_key([
                        ...
                        'wraactive',
                        'policynumber',
                        'recoveryreserve_extid',
                        'recoveryinvoice_extid'
