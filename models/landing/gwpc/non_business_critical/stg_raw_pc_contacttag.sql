...
2026-01-01      0.0                             Incremental staging model for pc_contacttag.
...
{{ config(
    ...
    tags=["raw_layer", "raw_policy_centre", "policy_centre", "non_business_critical", "pc_contacttag"]
) }}
...
(
            ...
            SELECT
                ...
                'AVRO' file_type
            FROM {{ source('gwpc', 'pc_contacttag') }}
