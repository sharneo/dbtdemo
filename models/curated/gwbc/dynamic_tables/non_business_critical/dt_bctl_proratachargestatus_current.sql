...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_proratachargestatus.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_proratachargestatus')) }}
FROM {{ ref('v_bctl_proratachargestatus') }}
