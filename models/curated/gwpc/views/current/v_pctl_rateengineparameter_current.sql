...
2026-01-01      0.5                             Curated current-state view for pctl_rateengineparameter.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_rateengineparameter_current')) }}
    FROM {{ ref('dt_pctl_rateengineparameter_current') }}
