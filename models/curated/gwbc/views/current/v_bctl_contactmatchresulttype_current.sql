...
2026-01-01      0.5                             Curated current-state view for bctl_contactmatchresulttype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bctl_contactmatchresulttype_current')) }}
    FROM {{ ref('dt_bctl_contactmatchresulttype_current') }}
