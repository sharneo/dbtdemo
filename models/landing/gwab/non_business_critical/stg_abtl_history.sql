...
2026-01-01      0.0                             Incremental staging model for abtl_history.
...
{{ config(
    ...
    tags=["layer:stg", "platform:guidewire","module:gwab","domain:contact_manager", "criticality:non_business_critical", "entity:abtl_history"]
) }}
