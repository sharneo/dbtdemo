...
2026-01-01      0.5                             SCD Type II view over ccx_claimtransferhistory_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_claimtransferhistory_ext')) }}
    FROM {{ ref('ccx_claimtransferhistory_ext') }}
