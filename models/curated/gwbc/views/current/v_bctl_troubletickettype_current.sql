...
2026-01-01      0.5                             Curated current-state view for bctl_troubletickettype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bctl_troubletickettype_current')) }}
    FROM {{ ref('dt_bctl_troubletickettype_current') }}
