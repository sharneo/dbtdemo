...
2026-01-01      0.5                             Curated current-state view for ccx_prtlclaimupd_icare__note.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_ccx_prtlclaimupd_icare__note_current')) }}
    FROM {{ ref('dt_ccx_prtlclaimupd_icare__note_current') }}
