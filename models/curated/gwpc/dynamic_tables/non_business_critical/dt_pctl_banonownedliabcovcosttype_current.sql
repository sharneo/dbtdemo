...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_banonownedliabcovcosttype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_banonownedliabcovcosttype')) }}
FROM {{ ref('v_pctl_banonownedliabcovcosttype') }}
