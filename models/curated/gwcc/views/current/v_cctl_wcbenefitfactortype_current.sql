...
2026-01-01      0.5                             Curated current-state view for cctl_wcbenefitfactortype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cctl_wcbenefitfactortype_current')) }}
    FROM {{ ref('dt_cctl_wcbenefitfactortype_current') }}
