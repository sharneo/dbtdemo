...
2026-01-01      0.5                             SCD Type II view over pcx_lprplusadjustfactor_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('pcx_lprplusadjustfactor_ext')) }}
    FROM {{ ref('pcx_lprplusadjustfactor_ext') }}
