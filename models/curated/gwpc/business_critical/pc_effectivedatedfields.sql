...
2026.01.11      0.0                             This Creates a DBT Incremental Model for the Curated Layer
                                                This Model is for the Curated table pc_effectivedatedfields in Schema gwpc in the Curated Layer 
-#}
...
SELECT
    {{ dbt_utils.star(from=ref('vw_raw_pc_effectivedatedfields')) }}
FROM {{ ref('vw_raw_pc_effectivedatedfields') }} AS src
