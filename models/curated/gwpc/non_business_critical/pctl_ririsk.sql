...
2026.01.11      0.0                             This Creates a DBT Incremental Model for the Curated Layer
                                                This Model is for the Curated table pctl_ririsk in Schema gwpc in the Curated Layer 
-#}
...
SELECT
    {{ dbt_utils.star(from=ref('vw_raw_pctl_ririsk')) }}
FROM {{ ref('vw_raw_pctl_ririsk') }} AS src
