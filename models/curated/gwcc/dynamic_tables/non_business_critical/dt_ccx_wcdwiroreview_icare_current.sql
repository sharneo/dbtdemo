...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_wcdwiroreview_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_wcdwiroreview_icare')) }}
FROM {{ ref('v_ccx_wcdwiroreview_icare') }}
