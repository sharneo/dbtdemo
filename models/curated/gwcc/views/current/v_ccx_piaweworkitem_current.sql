...
2026-01-01      0.5                             Curated current-state view for ccx_piaweworkitem.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_ccx_piaweworkitem_current')) }}
    FROM {{ ref('dt_ccx_piaweworkitem_current') }}
