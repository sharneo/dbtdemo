...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_basemoneyreceived.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_basemoneyreceived')) }}
FROM {{ ref('v_bctl_basemoneyreceived') }}
