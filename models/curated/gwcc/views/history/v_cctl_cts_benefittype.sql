...
2026-01-01      0.0                             Curated SCD2 full history view for cctl_cts_benefittype.
...
{{ config(
    materialized='view',
    tags=["curated", "curated_view", "curated_history", "claim_centre", "non_business_critical", "cctl_cts_benefittype"]
) }}
