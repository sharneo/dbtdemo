...
2026-01-01      0.5                             SCD Type II view over ccx_wpidoctorassessment_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_wpidoctorassessment_icare')) }}
    FROM {{ ref('ccx_wpidoctorassessment_icare') }}
