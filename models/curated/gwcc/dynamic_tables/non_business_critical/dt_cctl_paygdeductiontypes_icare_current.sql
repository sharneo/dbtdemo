...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_paygdeductiontypes_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_paygdeductiontypes_icare')) }}
FROM {{ ref('v_cctl_paygdeductiontypes_icare') }}
