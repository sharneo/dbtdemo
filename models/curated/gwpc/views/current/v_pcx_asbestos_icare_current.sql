...
2026-01-01      0.5                             Curated current-state view for pcx_asbestos_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pcx_asbestos_icare_current')) }}
    FROM {{ ref('dt_pcx_asbestos_icare_current') }}
