...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_bulkuploadbatchstatus_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_bulkuploadbatchstatus_icare')) }}
FROM {{ ref('v_pctl_bulkuploadbatchstatus_icare') }}
