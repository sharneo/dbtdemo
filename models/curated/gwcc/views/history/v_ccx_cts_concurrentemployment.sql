...
2026-01-01      0.5                             SCD Type II view over ccx_cts_concurrentemployment.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_cts_concurrentemployment')) }}
    FROM {{ ref('ccx_cts_concurrentemployment') }}
