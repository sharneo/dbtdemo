...
2026-01-01      0.5                             SCD Type II view over ccx_piaweindexremreport_ext.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_piaweindexremreport_ext')) }}
    FROM {{ ref('ccx_piaweindexremreport_ext') }}
