{% snapshot pl_gbs_payments_snapshot %}
...
2026.01.11      0.0                             This Creates a  View for the Snapshot for the Table pl_gbs_payments_snapshot . 
...
{{ config(
    ...
    unique_key='pl_gbs_payments_sk',
    strategy='check',
    alias='pl_gbs_payments',
    ...
    tags=['snapshot_tmf','snapshot_curated','snapshot','pl_gbs_payments']
) }}
...
WITH source_data AS (
    ...
    FROM {{ source('ifnsw_claim_interface', 'pl_gbs_payments') }}
)
