...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_mergeconflictstrategy.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_mergeconflictstrategy')) }}
FROM {{ ref('v_cctl_mergeconflictstrategy') }}
