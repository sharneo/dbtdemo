...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_prtlclaimupd_icare__note.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_prtlclaimupd_icare__note')) }}
FROM {{ ref('v_ccx_prtlclaimupd_icare__note') }}
