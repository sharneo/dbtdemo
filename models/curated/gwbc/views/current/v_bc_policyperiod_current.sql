...
2026-01-01      0.0                             Curated current-state view for bc_policyperiod.
...
{{ config(
    materialized='view',
    tags=["curated", "curated_view", "curated_current", "billing_centre", "business_critical", "bc_policyperiod"]
) }}
