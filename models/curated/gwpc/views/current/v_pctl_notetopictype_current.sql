...
2026-01-01      0.5                             Curated current-state view for pctl_notetopictype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_notetopictype_current')) }}
    FROM {{ ref('dt_pctl_notetopictype_current') }}
