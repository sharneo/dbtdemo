...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_fullpaydscworkitem.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_fullpaydscworkitem')) }}
FROM {{ ref('v_bctl_fullpaydscworkitem') }}
