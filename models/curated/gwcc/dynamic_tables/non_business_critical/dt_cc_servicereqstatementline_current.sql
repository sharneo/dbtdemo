...
2026-01-01      0.5                             Dynamic Table for current-state of cc_servicereqstatementline.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cc_servicereqstatementline')) }}
FROM {{ ref('v_cc_servicereqstatementline') }}
