...
2026-01-01      0.5                             SCD Type II view over cc_servicereqinstructionsvc.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('cc_servicereqinstructionsvc')) }}
    FROM {{ ref('cc_servicereqinstructionsvc') }}
