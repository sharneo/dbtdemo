...
2026-01-01      0.5                             Dynamic Table for current-state of abtl_dpplatformtype_ext.
...
SELECT
    {{ dbt_utils.star(from=ref('v_abtl_dpplatformtype_ext')) }}
FROM {{ ref('v_abtl_dpplatformtype_ext') }}
