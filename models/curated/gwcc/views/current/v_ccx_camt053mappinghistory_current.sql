...
2026-01-01      0.5                             Curated current-state view for ccx_camt053mappinghistory.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_ccx_camt053mappinghistory_current')) }}
    FROM {{ ref('dt_ccx_camt053mappinghistory_current') }}
