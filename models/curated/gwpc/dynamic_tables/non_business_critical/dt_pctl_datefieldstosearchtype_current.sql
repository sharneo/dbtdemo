...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_datefieldstosearchtype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_datefieldstosearchtype')) }}
FROM {{ ref('v_pctl_datefieldstosearchtype') }}
