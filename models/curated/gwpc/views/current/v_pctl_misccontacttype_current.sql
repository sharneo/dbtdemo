...
2026-01-01      0.5                             Curated current-state view for pctl_misccontacttype.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_misccontacttype_current')) }}
    FROM {{ ref('dt_pctl_misccontacttype_current') }}
