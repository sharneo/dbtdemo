{% snapshot mi_gbs_estimates_snapshot %}
...
2026.01.11      0.0                             This Creates a  View for the Snapshot for the Table mi_gbs_estimates_snapshot . 
...
{{ config(
    ...
    unique_key='mi_gbs_estimates_sk',
    strategy='check',
    alias='mi_gbs_estimates',
    ...
    tags=['snapshot_tmf','snapshot_curated','snapshot','mi_gbs_estimates']
) }}
...
WITH source_data AS (
    ...
    FROM {{ source('ifnsw_claim_interface', 'mi_gbs_estimates') }}
)
