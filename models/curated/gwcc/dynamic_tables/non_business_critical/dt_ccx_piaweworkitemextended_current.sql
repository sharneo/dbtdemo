...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_piaweworkitemextended.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_piaweworkitemextended')) }}
FROM {{ ref('v_ccx_piaweworkitemextended') }}
