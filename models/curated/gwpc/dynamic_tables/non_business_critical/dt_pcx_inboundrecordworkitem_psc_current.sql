...
2026-01-01      0.5                             Dynamic Table for current-state of pcx_inboundrecordworkitem_psc.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pcx_inboundrecordworkitem_psc')) }}
FROM {{ ref('v_pcx_inboundrecordworkitem_psc') }}
