...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_prodcorrespondencetype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_prodcorrespondencetype')) }}
FROM {{ ref('v_bctl_prodcorrespondencetype') }}
