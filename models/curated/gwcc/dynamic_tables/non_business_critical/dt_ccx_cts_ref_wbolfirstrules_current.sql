...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_cts_ref_wbolfirstrules.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_cts_ref_wbolfirstrules')) }}
FROM {{ ref('v_ccx_cts_ref_wbolfirstrules') }}
