...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_exposuretexttype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_exposuretexttype')) }}
FROM {{ ref('v_cctl_exposuretexttype') }}
