...
2026-01-01      0.0                             Incremental staging model for pc_policyperiod.
...
(
            ...
            SELECT
                ...
                data_payload:IsWagesConsentProvided_Ext::BOOLEAN AS iswagesconsentprovided_ext,
            ...
            SELECT
                ...
                $1:iswagesconsentprovided_ext::BOOLEAN AS iswagesconsentprovided_ext,
