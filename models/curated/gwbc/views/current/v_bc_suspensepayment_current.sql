...
2026-01-01      0.5                             Curated current-state view for bc_suspensepayment.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_bc_suspensepayment_current')) }}
    FROM {{ ref('dt_bc_suspensepayment_current') }}
