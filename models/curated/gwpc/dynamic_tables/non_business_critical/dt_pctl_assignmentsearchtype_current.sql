...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_assignmentsearchtype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_assignmentsearchtype')) }}
FROM {{ ref('v_pctl_assignmentsearchtype') }}
