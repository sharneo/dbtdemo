...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_downpaymntsecondinstllmnt.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_downpaymntsecondinstllmnt')) }}
FROM {{ ref('v_bctl_downpaymntsecondinstllmnt') }}
