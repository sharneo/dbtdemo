...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_bulkuploadstatus_icare.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_bulkuploadstatus_icare')) }}
FROM {{ ref('v_bctl_bulkuploadstatus_icare') }}
