...
2026-01-01      0.5                             Dynamic Table for current-state of bctl_documentsecuritytype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_bctl_documentsecuritytype')) }}
FROM {{ ref('v_bctl_documentsecuritytype') }}
