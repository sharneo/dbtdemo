...
2026-01-01      0.5                             SCD Type II view over ccx_managingentityorg_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_managingentityorg_icare')) }}
    FROM {{ ref('ccx_managingentityorg_icare') }}
