...
2026-01-01      0.0                             Incremental staging model for bctl_monetaryoridecurrency_sp.
...
{{ config(
    ...
    tags=["raw_layer", "raw_billing_centre", "billing_centre", "non_business_critical", "bctl_monetaryoridecurrency_sp"]
) }}
...
(
            ...
            SELECT
                ...
                'AVRO' file_type
            FROM {{ source('gwbc', 'bctl_monetaryoridecurrency_sp') }}
