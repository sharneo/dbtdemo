...
2026-01-01      0.5                             Curated current-state view for cctl_odgflag_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cctl_odgflag_icare_current')) }}
    FROM {{ ref('dt_cctl_odgflag_icare_current') }}
