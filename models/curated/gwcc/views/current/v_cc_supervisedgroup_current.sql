...
2026-01-01      0.5                             Curated current-state view for cc_supervisedgroup.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_cc_supervisedgroup_current')) }}
    FROM {{ ref('dt_cc_supervisedgroup_current') }}
