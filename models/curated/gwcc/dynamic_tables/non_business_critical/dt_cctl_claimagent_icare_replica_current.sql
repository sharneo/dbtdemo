...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_claimagent_icare_replica.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_claimagent_icare_replica')) }}
FROM {{ ref('v_cctl_claimagent_icare_replica') }}
