...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_validationissuetype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_validationissuetype')) }}
FROM {{ ref('v_pctl_validationissuetype') }}
