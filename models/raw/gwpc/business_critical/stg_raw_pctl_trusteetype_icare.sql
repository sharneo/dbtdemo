...
2026-01-01      0.0                             Incremental staging model for pctl_trusteetype_icare.
...
{{ config(
    ...
    tags=["raw_layer", "raw_policy_centre", "policy_centre", "business_critical", "pctl_trusteetype_icare"]
) }}
...
(
            ...
            SELECT
                ...
                'AVRO' file_type
            FROM {{ source('gwpc', 'pctl_trusteetype_icare') }}
