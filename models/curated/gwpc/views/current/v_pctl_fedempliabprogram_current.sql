...
2026-01-01      0.5                             Curated current-state view for pctl_fedempliabprogram.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('dt_pctl_fedempliabprogram_current')) }}
    FROM {{ ref('dt_pctl_fedempliabprogram_current') }}
