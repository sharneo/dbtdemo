...
2026.01.11      0.0                             This Creates a DBT Incremental Model for the Curated Layer
                                                This Model is for the Curated table cctl_casemgmtservice_icare in Schema gwcc in the Curated Layer 
-#}
...
SELECT
    {{ dbt_utils.star(from=ref('vw_raw_cctl_casemgmtservice_icare')) }}
FROM {{ ref('vw_raw_cctl_casemgmtservice_icare') }} AS src
