...
2026-01-01      0.5                             SCD Type II view over ccx_liabilitystatushist_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_liabilitystatushist_icare')) }}
    FROM {{ ref('ccx_liabilitystatushist_icare') }}
