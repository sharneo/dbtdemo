...
2026-01-01      0.5                             Dynamic Table for current-state of cctl_contactsearchtype.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cctl_contactsearchtype')) }}
FROM {{ ref('v_cctl_contactsearchtype') }}
