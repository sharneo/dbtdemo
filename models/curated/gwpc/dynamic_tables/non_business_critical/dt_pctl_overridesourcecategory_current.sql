...
2026-01-01      0.5                             Dynamic Table for current-state of pctl_overridesourcecategory.
...
SELECT
    {{ dbt_utils.star(from=ref('v_pctl_overridesourcecategory')) }}
FROM {{ ref('v_pctl_overridesourcecategory') }}
