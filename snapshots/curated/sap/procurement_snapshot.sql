...
2026-01-01      0.0                             This creates a SCD Type 2 Record for the Data in the RAW Table . This will run for PROCUREMENT
...
{{ config(
    ...
    tags=['sap','snapshot','procurement_snapshot']
) }}
