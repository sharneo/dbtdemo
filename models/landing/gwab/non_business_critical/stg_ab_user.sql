...
2026-01-01      0.0                             Incremental staging model for ab_user.
...
{{ config(
    ...
    tags=["layer:stg", "platform:guidewire","module:gwab","domain:contact_manager", "criticality:non_business_critical", "entity:ab_user"]
) }}
...
(
            ...
            SELECT
                ...
                data_payload:IntegerExt::NUMBER AS integerext,
            ...
            SELECT
                ...
                $1:integerext::NUMBER AS integerext,
