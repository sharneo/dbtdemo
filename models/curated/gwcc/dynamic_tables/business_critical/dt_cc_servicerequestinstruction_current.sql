...
2026-01-01      0.5                             Dynamic Table for current-state of cc_servicerequestinstruction.
...
SELECT
    {{ dbt_utils.star(from=ref('v_cc_servicerequestinstruction')) }}
FROM {{ ref('v_cc_servicerequestinstruction') }}
