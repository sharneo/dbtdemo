...
2026-01-01      0.5                             SCD Type II view over ccx_paygsummaryhistory_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_paygsummaryhistory_icare')) }}
    FROM {{ ref('ccx_paygsummaryhistory_icare') }}
