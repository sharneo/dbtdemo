...
2026-01-01      0.5                             Dynamic Table for current-state of ccx_documentattachmentpsc.
...
SELECT
    {{ dbt_utils.star(from=ref('v_ccx_documentattachmentpsc')) }}
FROM {{ ref('v_ccx_documentattachmentpsc') }}
