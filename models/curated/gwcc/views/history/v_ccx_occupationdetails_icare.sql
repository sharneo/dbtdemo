...
2026-01-01      0.5                             SCD Type II view over ccx_occupationdetails_icare.
...
(
    SELECT
        {{ dbt_utils.star(from=ref('ccx_occupationdetails_icare')) }}
    FROM {{ ref('ccx_occupationdetails_icare') }}
